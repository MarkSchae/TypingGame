"""
Django settings for typgame project.
...
MEDIA_ROOT = BASE_DIR / 'media'  # Directory where media files will be saved
...
WSGI_APPLICATION = 'typgame.wsgi.application'

ASGI_APPLICATION = "typgame.asgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        default=os.environ.get("DATABASE_URL")  # Name of the env variable
    )
}
